...
public class ShadowArea {
	...
	protected ShadowArea(Matrix4f lightViewMatrix, Camera camera) {
	...
	protected void update() {
		...
		toNear.scale(RendererMain.NEAR_PLANE);
	...
	private void calculateWidthsAndHeights() {
		farWidth = (float) (SHADOW_DISTANCE * Math.tan(Math.toRadians(RendererMain.FOV)));
		nearWidth = (float) (RendererMain.NEAR_PLANE
				* Math.tan(Math.toRadians(RendererMain.FOV)));
