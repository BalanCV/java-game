...
public class AdvancedParticle {
	...
	public AdvancedParticle(ParticleTexture texture, float pps, float speed, float gravityComplient, float lifeLength, float scale) {
		this.pps = pps;
	...
	public void generateParticles(Vector3f systemCenter) {
		float delta = DisplayWindow.getFrameTimeSeconds();
